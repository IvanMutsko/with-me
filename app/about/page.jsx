export default function About() {
  return (
    <main>
      <section>
        <h1>
          <strong>WithMe</strong>
        </h1>
        <p>Додаток для створення подій, пошуку друзів та спілкування</p>
      </section>
      <section>
        <h2>Key Features</h2>
        <p>
          Discover the powerful features that make WithMe the go-to app for
          creating and enhancing your social experiences.
        </p>
        <ul>
          <li>
          ...
          <li>
            ...
            <p>
              Navigate events with ease using interactive maps. WithMe provides
              detailed maps to help you locate venues, find your friends, and
              explore the event space effortlessly.
            </p>
          </li>
          <li>
          ...
          <li>
            <strong>Photo and Media Sharing:</strong>
            <p>
              Capture and share your favorite moments directly within the app.
              With integrated photo and media sharing, you can relive the
              highlights of events and keep the memories alive.
            </p>
          </li>
          <li>
